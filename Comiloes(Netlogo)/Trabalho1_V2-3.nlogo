...
to MoveLimpadores
  ...
  ask limpadores
  [
    ifelse [pcolor] of patch-here = green and energia < Energiainicial * 3
    [
...
to reprodcomiloes
  ...
  ask comiloes
  [
    if energia > Energiainicial * 8
    [
      set energia 100
      hatch 1 [while [[pcolor] of patch-here != 0][setxy random-pxcor random-pycor]]
    ]
  ]
...
"Comiloes" 1.0 0 -7500403 true "" "plot count comiloes"
"limpadores" 1.0 0 -955883 true "" "plot count limpadores"
