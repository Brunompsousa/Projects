...
globals [ReposicaoAlimento ReposicaoLixoNormal ReposicaoLixoToxico ResiduosDepositados]

to Setup

  clear-all
  set ReposicaoAlimento 0
  set ReposicaoLixoNormal 0
  set ReposicaoLixoToxico 0
...
to Go
  ...
  set ReposicaoLixoNormal 0 ; Contador de LixoNormal reset
  set ReposicaoLixoToxico 0 ; Contador de LixoToxico reset

  MoveComiloes
  MoveLimpadores

  ask n-of ReposicaoAlimento patches with [pcolor = 0 ] [ set pcolor green ] ; Reposicao dos alimentos consumidos pelos agentes
  ask n-of ReposicaoLixoNormal patches with [pcolor = 0 ] [ set pcolor yellow ] ; Reposicao do lixo normal recolhido por os limpadores
  ask n-of ReposicaoLixoToxico patches with [pcolor = 0 ] [ set pcolor red ] ; Reposicao do lixo toxico recolhido por os limpadores
      ...
      [
        ...
        [
          ...
          [
            ...
            set ReposicaoLixoNormal ReposicaoLixoNormal + 1
          ]
          [
            ...
            [
              ...
              set ReposicaoLixoToxico ReposicaoLixoToxico + 1
            ]
          ]
        ]
        [
...
to checkDeath
   ...
   ask turtles
   [
     if energia < 1 [die] ; Se um agente tiver menos de 1 de energia, morre
   ]
